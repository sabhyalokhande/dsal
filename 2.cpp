...
public:
    ...
    void insert();
    void Differerence();
    int size(); // Function to return the number of elements in the set
};
...
void set::search(int key) {
    for (t = l.begin(), t1 = l1.begin(); t != l.end(), t1!=l1.end(); t++, t1++) {
        if (*t == key || *t1 == key) {
...
int main() {
    ...
    while (1) {
        ...
        case 7:
            ...
            break;
        case 8:
            cout << "Size of the set: " << s.size() << endl; // Display the size of the set
            break;
        case 9:
            cout << "Exiting...";
            exit(1);
